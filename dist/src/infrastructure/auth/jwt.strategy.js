...
exports.JwtStrategy = exports.ACCOUNT_DISABLED_MESSAGE = void 0;
 ...
 */
exports.ACCOUNT_DISABLED_MESSAGE = 'CUENTA_DESHABILITADA';
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    async validate(payload) {
        ...
        if (!user) {
            throw new common_1.UnauthorizedException('Cuenta no encontrada.');
        }
        if (user.isDisabled) {
            throw new common_1.UnauthorizedException(exports.ACCOUNT_DISABLED_MESSAGE);
        }
