 ...
 */
let FirebaseStorageAdapter = class FirebaseStorageAdapter {
    async upload(file) {
        const bucket = admin.storage().bucket();
        const extension = file.originalName.split('.').pop() ?? 'jpg';
        const destination = `pings/${(0, crypto_1.randomUUID)()}.${extension}`;
...
exports.FirebaseStorageAdapter = FirebaseStorageAdapter = __decorate([
